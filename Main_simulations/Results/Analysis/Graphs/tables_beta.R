...
df$controlprob[df$controlprob == "Symmetric"] <- "U-shaped control control probabilities"
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Bias)) +
  ...
  myTheme
ggsave("table_beta_bias_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Bias)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_beta_bias_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Coverage)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_beta_coverage_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Coverage)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_beta_coverage_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Mean Squared Error`)) +
  ...
  coord_fixed()+
  scale_fill_gradientn(colours=c("white","darksalmon"),limits=c(0, 0.25)) +
  facet_grid2(controlprob~effectsize+sampsize) +
  labs(x = "Number of categories", y = "Prior Distribution for β") +
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_beta_mse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Mean Squared Error`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_beta_mse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Relative Bias (%)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_beta_relbias_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Relative Bias (%)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_beta_relbias_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Pr(OR > 1 | Data)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_beta_postprob_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Pr(OR > 1 | Data)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_beta_postprob_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `% declaring superiority`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_beta_propsuperiority_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Proportion of trials stopping MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_beta_propstop_mcse_adaptive.png",width = 20, height = 15)
