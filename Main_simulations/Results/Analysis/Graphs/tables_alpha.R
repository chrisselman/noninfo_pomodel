...
data <- read_excel('dataforgraph_alpha.xlsx')
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Bias)) +
  ...
  myTheme
ggsave("table_alpha_bias_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Bias)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_alpha_bias_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Coverage)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_alpha_coverage_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = Coverage)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_alpha_coverage_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Mean Squared Error`)) +
  ...
  coord_fixed()+
  scale_fill_gradientn(colours=c("white","darksalmon"),limits=c(0, 0.6)) +
  facet_grid2(controlprob~effectsize+sampsize) +
  labs(x = "Number of categories", y = "Prior Distribution for α") +
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_mse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Mean Squared Error`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_mse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Relative Bias (%)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_alpha_relbias_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Relative Bias (%)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme
ggsave("table_alpha_relbias_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Pr(OR > 1 | Data)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_postprob_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Pr(OR > 1 | Data)`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_postprob_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `% declaring superiority`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_propsuperiority_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `% declaring superiority`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_propsuperiority_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `% stopping early`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_propstopearly_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Bias MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_bias_mcse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Bias MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_bias_mcse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Relative Bias MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_relbias_mcse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Relative Bias MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_relbias_mcse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Coverage MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_coverage_mcse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Coverage MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_coverage_mcse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Mean-Squared Error MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_mse_mcse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Mean-Squared Error MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_mse_mcse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Pr(OR > 1 | Data) MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_postprob_mcse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Pr(OR > 1 | Data) MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_postprob_mcse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Proportion declaring superiority MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_postsup_mcse_fixed.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Proportion declaring superiority MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_postsup_mcse_adaptive.png",width = 20, height = 15)
...
ggplot(df, aes(x = category, y = `Prior Distribution`, fill = `Proportion of trials stopping MCSE`)) +
  ...
  scale_x_discrete(labels = category) +
  myTheme 
ggsave("table_alpha_propstop_mcse_adaptive.png",width = 20, height = 15)
