...
setwd("/group/cebu1/BACKUP/Chris/Project_3/noninfo_pomodel/Main_simulations/Alpha_prior/Moderate_n/Fixed/10_categories/Uniform/Moderate_effect")
...
bias_dirones[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50)
...
coverage_dirones[k] <- ifelse(lci <= log(1.50) & uci >= log(1.50), 1, 0)

# MSE 
mse_dirones[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_dirzero[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50)
...
coverage_dirzero[k] <- ifelse(lci <= log(1.50) & uci >= log(1.50), 1, 0)

# MSE 
mse_dirzero[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_dirjef[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50)
...
coverage_dirjef[k] <- ifelse(lci <= log(1.50) & uci >= log(1.50), 1, 0)

# MSE 
mse_dirjef[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_dirrec[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50)
...
coverage_dirrec[k] <- ifelse(lci <= log(1.50) & uci >= log(1.50), 1, 0)

# MSE 
mse_dirrec[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_normal[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50)
...
coverage_normal[k] <- ifelse(lci <= log(1.50) & uci >= log(1.50), 1, 0)

# MSE 
mse_normal[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.50))^2
