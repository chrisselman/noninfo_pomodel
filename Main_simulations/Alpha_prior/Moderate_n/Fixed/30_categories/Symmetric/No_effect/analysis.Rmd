...
```{r}
library(miceadds)
data <- do.call(rbind,lapply(paste0("sim_performance",c(5:38),".Rdata"), load.Rdata2))
...
write.csv(results,file="G:/BACKUP/Chris/Project_3/Main_Simulations/Results/results_94.csv")
```
