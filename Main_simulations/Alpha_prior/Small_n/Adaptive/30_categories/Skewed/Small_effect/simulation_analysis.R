...
setwd("/group/cebu1/BACKUP/Chris/Project_3/Main_simulations/Alpha_prior/Small_n/Adaptive/30_categories/Skewed/Small_effect")
...
freqmod <- polr(as.factor(y)~x, data = example_data,
                Hess = TRUE)
