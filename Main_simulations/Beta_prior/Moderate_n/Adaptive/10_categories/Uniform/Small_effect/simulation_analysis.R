...
setwd("/group/cebu1/BACKUP/Chris/Project_3/noninfo_pomodel/Main_simulations/Beta_prior/Moderate_n/Adaptive/10_categories/Uniform/Small_effect")
...
bias_normal_largesd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10)
...
coverage_normal_largesd[k] <- ifelse(lci <= log(1.10) & uci >= log(1.10), 1, 0)

# MSE 
mse_normal_largesd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10))^2
...
if (postprob > 0.99) {
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_normal_smallsd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10)
  ...
  coverage_normal_smallsd[k] <- ifelse(lci <= log(1.10) & uci >= log(1.10), 1, 0)
  
  # MSE 
  mse_normal_smallsd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10))^2
...
if (postprob > 0.99) {
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_laplace_largesd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10)
  ...
  coverage_laplace_largesd[k] <- ifelse(lci <= log(1.10) & uci >= log(1.10), 1, 0)
  
  # MSE 
  mse_laplace_largesd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10))^2
...
if (postprob > 0.99) {
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_laplace_smallsd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10)
  ...
  coverage_laplace_smallsd[k] <- ifelse(lci <= log(1.10) & uci >= log(1.10), 1, 0)
  
  # MSE 
  mse_laplace_smallsd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10))^2
...
if (postprob > 0.99) {
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_cauchy[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10)
  ...
  coverage_cauchy[k] <- ifelse(lci <= log(1.10) & uci >= log(1.10), 1, 0)
  
  # MSE 
  mse_cauchy[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10))^2
...
if (postprob > 0.99) {
  ...
  # Extract summary for proportional OR 
  # Bias for each cumulative logit 
  bias_rsquare[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10)
  ...
  coverage_rsquare[k] <- ifelse(lci <= log(1.10) & uci >= log(1.10), 1, 0)
  
  # MSE 
  mse_rsquare[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.10))^2
...
bias_freq[k] <- as.numeric(freqmod$coefficients) - log(1.10)

coverage_freq[k] <- ifelse(as.numeric(confint(freqmod)[1]) <= log(1.10) & as.numeric(confint(freqmod)[2]) >= log(1.10), 1, 0)

mse_freq[k] <-  (as.numeric(freqmod$coefficients) - log(1.10))^2
