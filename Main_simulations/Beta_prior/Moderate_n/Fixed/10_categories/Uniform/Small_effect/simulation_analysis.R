...
setwd("/group/cebu1/BACKUP/Chris/Project_3/noninfo_pomodel/Main_simulations/Beta_prior/Moderate_n/Fixed/10_categories/Uniform/Small_effect")
...
bias_normal_largesd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1)
...
coverage_normal_largesd[k] <- ifelse(lci <= log(1.1) & uci >= log(1.1), 1, 0)

# MSE 
mse_normal_largesd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_normal_smallsd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1)
...
coverage_normal_smallsd[k] <- ifelse(lci <= log(1.1) & uci >= log(1.1), 1, 0)

# MSE 
mse_normal_smallsd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_laplace_largesd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1)
...
coverage_laplace_largesd[k] <- ifelse(lci <= log(1.1) & uci >= log(1.1), 1, 0)

# MSE 
mse_laplace_largesd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_laplace_smallsd[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1)
...
coverage_laplace_smallsd[k] <- ifelse(lci <= log(1.1) & uci >= log(1.1), 1, 0)

# MSE 
mse_laplace_smallsd[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_cauchy[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1)
...
coverage_cauchy[k] <- ifelse(lci <= log(1.1) & uci >= log(1.1), 1, 0)

# MSE 
mse_cauchy[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1))^2
...
# Extract summary for proportional OR 
# Bias for each cumulative logit 
bias_rsquare[k] <- as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1)
...
coverage_rsquare[k] <- ifelse(lci <= log(1.1) & uci >= log(1.1), 1, 0)

# MSE 
mse_rsquare[k] <- (as.numeric(summarise_draws(df, "median")[1,2]) - log(1.1))^2
