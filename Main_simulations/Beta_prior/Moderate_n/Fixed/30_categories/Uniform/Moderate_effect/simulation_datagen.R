...
setwd("G:/BACKUP/Chris/Project_3/noninfo_pomodel/Main_simulations/Beta_prior/Moderate_n/Fixed/30_categories/Uniform/Moderate_effect")
...
p0 <- c(rep(1/length(states),length(states)))
