...
```{r}
relbias_rsq <- (exp(bias_rsq + log(1.10))-exp(log(1.10)))/(exp(log(1.10)))
relbias_normlargesd <- (exp(bias_normlargesd+ log(1.10))-exp(log(1.10)))/(exp(log(1.10)))
relbias_normsmallsd <- (exp(bias_normsmallsd+ log(1.10))-exp(log(1.10)))/(exp(log(1.10)))
relbias_laplargesd <- (exp(bias_laplargesd+ log(1.10))-exp(log(1.10)))/(exp(log(1.10)))
relbias_lapsmallsd <- (exp(bias_lapsmallsd+ log(1.10))-exp(log(1.10)))/(exp(log(1.10)))
relbias_cauchy <- (exp(bias_cauch+ log(1.10))-exp(log(1.10)))/(exp(log(1.10)))
...
write.csv(results,file="G:/BACKUP/Chris/Project_3/noninfo_pomodel/Main_Simulations/Results/results_147.csv")
```
