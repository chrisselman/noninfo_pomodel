...
```{r}
relbias_rsq <- (exp(bias_rsq + log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
relbias_normlargesd <- (exp(bias_normlargesd+ log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
relbias_normsmallsd <- (exp(bias_normsmallsd+ log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
relbias_laplargesd <- (exp(bias_laplargesd+ log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
relbias_lapsmallsd <- (exp(bias_lapsmallsd+ log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
relbias_cauchy <- (exp(bias_cauch+ log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
relbias_frequentist <- (exp(bias_frequentist+ log(1.50))-exp(log(1.50)))/(exp(log(1.50)))
```
...
for(i in 1:nsim){
  MC_YMinusi_relbias_rsquare[i] = (exp(sum(bias_rsquare[-i])/(nsim-1)+ log(1.50))-exp(log(1.5)))/(exp(log(1.5)))
  MC_YMinusi_relbias_normlargesd[i] = (exp(sum(bias_normal_largesd[-i])/(nsim-1)+ log(1.50))-exp(log(1.5)))/(exp(log(1.5)))
  MC_YMinusi_relbias_normsmallsd[i] = (exp(sum(bias_normal_smallsd[-i])/(nsim-1)+ log(1.50))-exp(log(1.5)))/(exp(log(1.5)))
  MC_YMinusi_relbias_laplargesd[i] = (exp(sum(bias_laplace_largesd[-i])/(nsim-1)+ log(1.50))-exp(log(1.5)))/(exp(log(1.5)))
  MC_YMinusi_relbias_lapsmallsd[i] = (exp(sum(bias_laplace_smallsd[-i])/(nsim-1)+ log(1.50))-exp(log(1.5)))/(exp(log(1.5)))
  MC_YMinusi_relbias_cauch[i] = (exp(sum(bias_cauchy[-i])/(nsim-1)+ log(1.50))-exp(log(1.5)))/(exp(log(1.5)))
}
...
effectsize <- rep("Moderate [OR = 1.50]", 7)

controlprob <- rep("Uniform", 7)
